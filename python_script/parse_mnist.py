...
if __name__ == '__main__':
    ...
    images_file_path = "../example_data/mnist/ori/train-images.idx3-ubyte"
    images_save_folder = "../example_data/mnist/train_images"
    extract_images(images_file_path, images_save_folder)

    mnist_label_file_path = "../example_data/mnist/ori/train-labels.idx1-ubyte"
    label_file_path = "../example_data/mnist/training_label.txt"
    extract_labels(mnist_label_file_path, label_file_path)

    images_file_path = "../example_data/mnist/ori/t10k-images.idx3-ubyte"
    images_save_folder = "../example_data/mnist/test_images"
    extract_images(images_file_path, images_save_folder)

    mnist_label_file_path = "../example_data/mnist/ori/t10k-labels.idx1-ubyte"
    label_file_path = "../example_data/mnist/testing_label.txt"
    extract_labels(mnist_label_file_path, label_file_path)
